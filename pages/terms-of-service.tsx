    ...
    <>
      ...
      <Container>
        <div className="space-y-2">
          ...
          <p>
            The content on the website does to encourage anyone to use the same
            or similar phrases in your daily life. If you happen to use such
            kindly do at your own risk, we would not be held responsible for any
          ...
          <p>
            This project is independent and is not binded by any affiliation
            with @loewhaley, that being said the content of the website can be
            updated with time.
          </p>
